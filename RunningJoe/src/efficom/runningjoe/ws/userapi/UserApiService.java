 ...
 * 
 */
@WebServiceClient(name = "UserApiService", targetNamespace = "http://efficom/runningjoe/ws/UserApi/", wsdlLocation = "http://runningjoe.grimfor.fr/ws/UserApi?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://runningjoe.grimfor.fr/ws/UserApi?wsdl");
